...
export function GestionLogements() {
    ...
    return (
        <>
            <TabsContent actions={<div>
                <Button onClick={() => setAciveIndex(0)} className={`w-2rem h-2rem p-0 border-orange-500 border-1 rounded mr-2 ${activeIndex === 0 && 'bg-orange-300 rounded'}`} rounded outlined={activeIndex !== 0} label="1" />
                <Button onClick={() => setAciveIndex(1)} className={`w-2rem h-2rem p-0 border-orange-500 border-1 rounded mr-2 ${activeIndex === 1 && 'bg-orange-300 rounded'}`} rounded outlined={activeIndex !== 1} label="2" />
                <Button onClick={() => setAciveIndex(2)} className={`w-2rem h-2rem p-0 border-orange-500 border-1 rounded mr-2 ${activeIndex === 2 && 'bg-orange-300 rounded'}`} rounded outlined={activeIndex !== 2} label="3" />
                <Button onClick={() => setAciveIndex(3)} className={`w-2rem h-2rem p-0 border-orange-500 border-1 rounded mr-2 ${activeIndex === 3 && 'bg-orange-300 rounded'}`} rounded outlined={activeIndex !== 3} label="4" />
                <Button onClick={() => setAciveIndex(4)} className={`w-2rem h-2rem p-0 border-orange-500 border-1 rounded mr-2 ${activeIndex === 4 && 'bg-orange-300 rounded'}`} rounded outlined={activeIndex !== 4} label="5" />
                <Button onClick={() => setAciveIndex(5)} className={`w-2rem h-2rem p-0 border-orange-500 border-1 rounded mr-2 ${activeIndex === 5 && 'bg-orange-300 rounded'}`} rounded outlined={activeIndex !== 5} label="6" />
